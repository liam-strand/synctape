...
export class AppleMusicService implements StreamingService {
  ...
  async createPlaylist(
    ...
    console.log("AppleMusicService.createPlaylist - STUB", {
      name,
      description,
    });
  ...
  async updatePlaylistTracks(
    ...
    console.log("AppleMusicService.updatePlaylistTracks - STUB", {
      playlistId,
      trackCount: trackIds.length,
    });

    throw new Error(
      "AppleMusicService.updatePlaylistTracks not yet implemented",
    );
  }
